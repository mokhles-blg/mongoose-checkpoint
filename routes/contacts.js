// routes created on the collection contact :
...
router.get("/", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .send({ msg: "this is the list of all the contacts", listContacts });
  } catch (error) {
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    res
      .status(400)
      .send({ msg: "can not delete the contact", contactToDelete });
  }
});
...
router.put("/:id", async (req, res) => {
  try {
    ...
    res
      .status(400)
      .send({ msg: "can not update the contact", contactToUpdate });
  }
});
